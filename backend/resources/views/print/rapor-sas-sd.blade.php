...
@section('content')
    ...
    <table class="no-border" style="width: 100%; margin-bottom: 15px; font-size: 11pt;">
        ...
        <tr>
            ...
            <td>Semester</td>
            <td>:</td>
            <td><b>{{ $semester->semester == 1 ? 'GANJIL' : 'GENAP' }}</b></td>
        </tr>
        <tr>
            <td>Nama Sekolah</td>
            <td>:</td>
            <td><b>{{ $settings['school_name'] ?? 'SD KRISTEN KALAM KUDUS SENTANI' }}</b></td>
            <td>TP.</td>
            <td>:</td>
    ...
    {{-- Page Break for new sections --}}
    <div style="page-break-before: always;"></div>

    {{-- UGE Report --}}
    <div style="margin-bottom: 20px;">
        <table style="width: 100%; background-color: #1e40af; color: white;">
            <tr><th style="padding: 8px; text-align: center;">URBAN GREEN EDUCATION (UGE) CONVERSATION REPORT</th></tr>
        </table>
        <div style="border: 1px solid #ccc; padding: 15px; font-style: italic; text-align: justify; min-height: 60px;">
            {{ $catatanAkhir?->uge_report ?? '-' }}
        </div>
    </div>
    ...
    {{-- Kokurikuler Narrative --}}
    <div style="margin-bottom: 20px;">
        <b>KOKURIKULER</b>
        <div style="border: 1px solid #ccc; padding: 15px; text-align: justify; background-color: #f9f9f9; min-height: 60px;">
            {{ $catatanAkhir?->kokurikuler_catatan ?? '-' }}
        </div>
    </div>
        ...
        <table class="no-border" style="width: 100%;">
            ...
            <tr>
                <td colspan="2" style="text-align: center; padding-top: 30px;">
                    <p>Mengetahui</p>
                    <p><b>Kepala Sekolah Dasar</b></p>
                    <br><br><br>
                    <p><b><u>{{ $settings['kepala_sekolah_sd'] ?? 'NAMA KEPALA SEKOLAH' }}</u></b></p>
                </td>
            </tr>
        </table>
    </div>

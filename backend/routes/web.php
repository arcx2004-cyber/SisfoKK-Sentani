...
Route::get('/admin/siswa/print-all', [App\Http\Controllers\SiswaPrintController::class, 'printAll'])->name('siswa.print-all')->middleware('auth');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/cetak-kartu-pelajar/{siswa}', [\App\Http\Controllers\SiswaPrintController::class, 'printKartuPelajar'])->name('print.kartu-pelajar');

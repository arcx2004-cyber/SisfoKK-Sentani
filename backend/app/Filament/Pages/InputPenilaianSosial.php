...
class InputPenilaianSosial extends Page implements HasForms
{
    ...
    protected static ?string $title = 'Input Penilaian Sosial';

    protected static string $view = 'filament.pages.input-penilaian-sosial';
    ...
    public function mount(): void
    {
        ...
        foreach ($students as $siswa) {
            $existing = NilaiSosial::where('siswa_id', $siswa->id)
    ...
    protected function getStudents()
    {
        ...
        // For admin, return empty or all (based on requirement)
        return collect();
    }
    ...
    public function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\Section::make('Input Penilaian Sosial')
                    ->description('Masukkan nilai sosial untuk semua siswa di rombel Anda')
                    ->schema([
    ...
    public function save(): void
    {
        ...
        Notification::make()
            ->title("Berhasil menyimpan {$saved} nilai sosial")
            ->success()
            ->send();
    }

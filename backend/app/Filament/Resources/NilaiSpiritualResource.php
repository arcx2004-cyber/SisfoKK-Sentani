...
use App\Filament\Resources\NilaiSpiritualResource\Pages;
...
class NilaiSpiritualResource extends Resource
{
    protected static ?string $model = NilaiSpiritual::class;
    ...
    public static function getEloquentQuery(): Builder
    {
        ...
        if ($user->hasRole('wali_kelas') && $user->guru) {
            ...
            if ($wk) {
                // Filter records where the student belongs to the wali kelas's rombel
    ...
    {
        return [
            'index' => Pages\ListNilaiSpirituals::route('/'),
            'create' => Pages\CreateNilaiSpiritual::route('/create'),
            'edit' => Pages\EditNilaiSpiritual::route('/{record}/edit'),
        ];
    }
}
